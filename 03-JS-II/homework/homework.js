...
function conection(status) {
  ...
  // else if (status === 2) return "Away";   --> Es una forma de hacerlo
  // else return "Offline";                  -->
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if (!num1 || !num2 || !num3) return "Error" // if (num1 === 0 || num2 === 0 || num3 === 0) return "Error"
...
function esPrimo(numero) {
  ...
  if (numero === 0 || numero === 1) return false //if (numero < 2) return false
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  if (numero >= 100 && numero <= 999) { // if (String(numero).lenght === 3)
    return true;
  } else {
    return false;
  }
